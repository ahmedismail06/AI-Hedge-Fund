...
//  UPDATED with your actual API URL from vercel.json
//
...
enum AppConfig {
    ...
    // ⚠️ IMPORTANT: This uses HTTP (not HTTPS)
    // You'll need to configure App Transport Security in Info.plist
    enum API {
        static let baseURL = "http://YOUR_BACKEND_HOST:8000"
        static let apiVersion = "v1"
        static let timeout: TimeInterval = 30
        
        // Endpoints - All routes use /api prefix based on vercel.json
