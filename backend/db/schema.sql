...
-- ── Short Selling Pipeline ────────────────────────────────────────────────────
-- Written by run_short_screening() at 4 PM ET after the long screener completes.
-- source='watchlist': ticker scored from existing long screener data (0 extra API calls)
-- source='wide_universe': ticker is $2B–$10B, scored from weekly cache
