...
Architecture:
  - APScheduler runs run_pm_cycle() every 5 minutes (market hours + after-hours for cleanup)
    - Macro (7 AM), Screener (4 PM), Research queue (8:15 PM) crons are preserved unchanged
...
def create_orchestrator_scheduler():
    ...
    Schedule:
        - 07:00 ET Mon–Fri: trigger Macro Agent
            ...
            - 20:15 ET Mon–Fri: trigger Research queue
    ...
    # Research queue — 20:15 ET Mon–Fri
    scheduler.add_job(
        _trigger_research_queue,
        trigger=CronTrigger(
    ...
    # Runs after screener (16:00) and before research queue (20:15) so upcoming events
...
def _refresh_ticker_events_calendar() -> None:
    ...
    Runs at 16:15 ET (after screener at 16:00, before research at 20:15).
